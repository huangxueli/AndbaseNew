...
public class TableDataListActivity1 extends AbActivity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		// (3)列类型配置
		cellTypes = new int[] { AbCellType.STRING, AbCellType.STRING, AbCellType.STRING, AbCellType.IMAGE,AbCellType.STRING};
		// (4)列宽配置(%) 超过100% 可以横向滑动
